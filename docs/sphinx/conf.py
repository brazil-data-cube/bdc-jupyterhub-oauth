...
"""Configuration file for the Brazil Data Cube JupyterHub OAuth 2.0 documentation.
...
import bdc_jupyterhub_oauth
import sphinx_rtd_theme


# -- Project information -----------------------------------------------------

project = 'BDC_JUPYTERHUB_OAUTH'
copyright = '2021, INPE.'
author = 'Brazil Data Cube Team'
release = bdc_jupyterhub_oauth.__version__
...
html_title = 'BDC_JUPYTERHUB_OAUTH'

html_context = {
    'display_github': False,
    'github_user': 'brazil-data-cube',
    'github_repo': 'bdc-jupyterhub-oauth',
    'last_updated': False,
    #'commit': False,
}
...
#import os
#
#BDC_JUPYTERHUB_OAUTH_EXAMPLE_URL = os.getenv('BDC_JUPYTERHUB_OAUTH_EXAMPLE_URL', None)
#'''
